...
class MuJoCoSimulator:
    ...
    def __init__(self, model_path_or_name: str = None):
        ...
        self.model_path_or_name = (
            os.getenv("MODEL_NAME") or model_path_or_name or "go2_mj_description"
        )
    ...
    def load_model(self) -> bool:
        ...
        if model_path.exists() and model_path.suffix == ".xml":
            ...
            self.model = load_robot_description(
                self.model_path_or_name, variant="scene"
            )
        ...
        if self.model.nu > 0:
            ...
            for i in range(self.model.nu):
                ...
                print(
                    f"  [{i}] {actuator_name or f'actuator_{i}'} -> joint: {joint_name} | range: [{ctrl_range[0]:.2f}, {ctrl_range[1]:.2f}]"
                )

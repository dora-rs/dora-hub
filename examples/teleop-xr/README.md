...
```
[ teleop_xr ] --- right_hand_pose ---> [ controller ] --- ik_request ---> [ pytorch_kinematics ]
      |                                      ^                                    |
      |                                      |------------------------------------|
      |                                      |
      |--- head_pose ----------------------->| [ plot (rerun) ]
      |--- left_hand_pose ------------------>|
      |--- right_hand_pose ----------------->|
      |--- joint_state <---------------------|
```
...
- `head_pose`: 6DOF pose of the headset.
- `left_hand_pose`: 6DOF pose of the left controller.
- `right_hand_pose`: 6DOF pose of the right controller.
- `joint_state`: Solved joint angles for the SO101 arm.
